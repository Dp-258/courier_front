...
<template>
    <div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div @click="setSearchParams('prealerts')" 
            class="py-5 h-fit bg-white border border-gray-200 rounded-lg shadow transition ease-in-out duration-200 
            ...
            <div @click="setSearchParams('packages')"
            class="py-5 h-fit bg-white border border-gray-200 rounded-lg shadow transition ease-in-out duration-200 
            hover:scale-105 hover:-translate-y-2 hover:shadow-amber-500 cursor-pointer"
